<style lang='less' src='./styles/theme.less'/>
<template>
	<div>
				...
				<nav class='uk-navbar'>
					<div class='uk-navbar-left'>
						<router-link to='/' class='uk-navbar-item uk-logo'>
							<img
								...
								:src="require('./images/uikit-logo.svg')"
								alt=''
								uk-svg
							>
							UIkit
					...
					<div class='uk-navbar-right'>
						<ul class='uk-navbar-nav uk-visible@m'>
							<li><a :href='nav.pro'>Pro</a></li>
							<li class='uk-active'><a>Documentation</a></li>
							<li><a :href='nav.changelog'>Changelog</a></li>
						</ul>
						<div class='uk-navbar-item uk-visible@m'>
							<a class='uk-button uk-button-default tm-button-default uk-icon'
								href='../download'>
								Download
		...
		<div class='tm-sidebar-left uk-visible@m'>
			<h3>Documentation</h3>
			<ul v-for='(pages, category, index) in navigation'
				...
				<div class='tm-sidebar-right uk-visible@l'>
					<div uk-sticky='offset: 160'>
						<ul class='uk-nav uk-nav-default tm-nav uk-nav-parent-icon'
							...
							<li>
								<a :href='`https://github.com/Grawl/uikit-site-vui-cli/tree/master/src/pages/${page}.md`'
									target='_blank'>
			...
			<div class='uk-offcanvas-bar'>
				<div class='uk-panel'>
					<ul class='uk-nav uk-nav-default tm-nav'>
						...
						<li><a :href='nav.pro'>Pro</a></li>
						<li><a :href='nav.changelog'>Changelog</a></li>
						<li><a :href='nav.download'>Download</a></li>
					</ul>
					<ul
...
<script>
	export default {
		data: () => ({
			nav: {
				home: 'https://getuikit.com/home',
				pro: 'https://getuikit.com/pro',
				changelog: 'https://getuikit.com/changelog',
				download: 'https://getuikit.com/download',
			},
		}),
	}
</script>
